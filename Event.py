class Event(object):
    ...
    def setOperon1GapEvents(self, operon1GapEvents):
        self.operon1GapEvents = operon1GapEvents

    def setOperon2GapEvents(self, operon2GapEvents):
        self.operon2GapEvents = operon2GapEvents
